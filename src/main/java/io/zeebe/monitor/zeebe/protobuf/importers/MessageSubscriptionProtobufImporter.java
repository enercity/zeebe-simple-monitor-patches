...
public class MessageSubscriptionProtobufImporter {
  ...
  public void importMessageSubscription(final Schema.MessageSubscriptionRecord record) {
    ...
    Counter.builder("message_subscription.imported").tag("state", entity.getState()).description("number of imported message subscriptions").register(meterRegistry).increment();
  }
  ...
  public void importMessageStartEventSubscription(
    ...
    Counter.builder("message_subscription.imported").tag("state", entity.getState()).description("number of message start events incidents").register(meterRegistry).increment();
  }
